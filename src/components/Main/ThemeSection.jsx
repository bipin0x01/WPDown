    ...
    return (
        <div className="theme-section w-full sm:p-0 p-4 border-2 shadow-lg hover:shadow-md transition ease-in-out auto shadow-slate-200 m-2 my-4 ">
            ...
            {themeDetails.theme ? (
                            ...
                            <Image
                                src={
                                    themeDetails.screenshot
                                        ? `https://res.cloudinary.com/kaji/image/fetch/${themeDetails.screenshot}`
                                        : 'https://res.cloudinary.com/kaji/image/fetch/https://via.placeholder.com/350*500'
                                }
                ...
                <>
                    <div className="theme-section-left flex flex-row justify-center  m-4">
                        {/* Theme Data Not Available */}
                        <div className="theme-info w-full p-2">
                            <div className="theme-name mb-3 text-lg text-center">
                                <h2>
                                    Sorry! We could not find any theme data for
                                    this theme. Please try again later.
                                </h2>
                            </div>
                        </div>
                    </div>
